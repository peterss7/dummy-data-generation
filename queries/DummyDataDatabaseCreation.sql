...
FROM "C:\Users\peter\eclipse-workspace\dummy-data-generation\prs-database-users.csv"
WITH
(
	FORMAT = 'CSV',	
	ROWTERMINATOR = '0x0a',
...
FROM "C:\Users\peter\eclipse-workspace\dummy-data-generation\prs-database-vendors.csv"
WITH
(
	FORMAT = 'CSV',	
	ROWTERMINATOR = '0x0a',
